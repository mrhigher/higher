...
class WPCustomerReviews {
    ...
    function get_options() {
        ...
        $default_options = array(
            ...
            'show_hcard' => 1,
            'show_hcard_on' => 1,
            'submit_button_text' => 'Добавить отзыв:',
            'support_us' => 0,
            'title_tag' => 'h2'
        );
    ...
    function pagination($total_results, $reviews_per_page) {
        ...
        if ($pages > 1) {
            ...
            $out .= '<div id="wpcr_pagination"><div id="wpcr_pagination_page">Страница </div>';
            ...
            foreach ($reviews as $review) {
                ...
                if ($hide_response == 0)
                {
                    if (strlen($review->review_response) > 0) {
                        $review_response = '<p class="response"><strong>Ответ администратора:</strong> ' . nl2br($review->review_response) . '</p>';
                    }
                }
